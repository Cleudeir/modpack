...
function loadConfig() {
    try {
        ...
        console.log('[blockrestoration] Config loaded: mainBlock=' + config.mainBlock + ' radius=' + config.radius + ' debug=' + config.debug);
    } catch (e) {
        console.log('[blockrestoration] ERRO lendo config, usando padrao: mainBlock=' + config.mainBlock);
    }
}
